...
class xrfBatch():
    ...
    def readData(self):
        self.x,self.y,self.xrf,self.energy, self.Emax = DM.stitchScans(self.scan_list,XRD=False,xrf_calibration = self.calibration,proposal=self.proposal,visit=self.visit) 
